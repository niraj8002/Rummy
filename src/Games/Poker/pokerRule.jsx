...
import rummySideImg from "../../assets/poker/poker.png";
import {
  FaArrowRight,
  FaChess,
  FaTrophy,
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-[14px] leading-relaxed">
                    Each player is dealt 13 cards. The remaining cards form the
                    closed deck, with one card placed face-up to start the open
                    deck. The dealer is chosen randomly at the beginning.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group p-6 bg-[#1e1e1e] rounded-xl border-l-4 border-[#5e0d0d] hover:border-[#ff6b6b] transition-all duration-300 hover:shadow-lg hover:shadow-[#5e0d0d]/20">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-[14px] leading-relaxed">
                    Arrange all 13 cards in valid sequences and/or sets. A valid
                    declaration must include at least two sequences, one of
                    which must be a pure sequence (without a joker).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-[14px] leading-relaxed">
                    ...
                    to the open pile. Form valid sequences/sets with your cards.
                    Jokers can substitute any card. You can use opponents'
                    discards if needed.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-[14px] leading-relaxed">
                    ...
                    cards. The game continues until a player reaches the target
                    score.
                  </p>
                </div>
              </div>
